...
Public Class MathFunction(Of T, TResult)
...
#Region "Properties"
    ...
    Private Property Inner As MathFunction(Of T, Object, Object, Object, TResult)
    ...
    ''' </summary>
    ''' <value></value>
    Default Public ReadOnly Property Item(ByVal x As T) As TResult
        Get
            Return Inner(x)
        End Get
    End Property
...
#Region "Constructor"
    ...
    Private Sub New(ByVal inner As MathFunction(Of T, Object, Object, Object, TResult))
        Me.Inner = inner
    End Sub
...
#Region "Methods"
    ...
    ''' <returns></returns>
    Public Function Evaluate(ByVal x As T) As TResult
    ...
    ''' <returns></returns>
    Public Shared Function Create(ByVal expression As String) As MathFunction(Of T, TResult)
        Return New MathFunction(Of T, TResult)(MathFunction(Of T, Object, Object, Object, TResult).Create(expression))
    End Function
