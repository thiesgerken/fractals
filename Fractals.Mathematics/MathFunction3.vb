...
Public Class MathFunction(Of T1, T2, T3, TResult)
...
#Region "Properties"
    ...
    Private Property Inner As MathFunction(Of T1, T2, T3, Object, TResult)
...
#Region "Constructor"
    ...
    Private Sub New(ByVal inner As MathFunction(Of T1, T2, T3, Object, TResult))
        Me.Inner = inner
    End Sub
...
#Region "Methods"
    ...
    ''' <returns></returns>
    Public Shared Function Create(ByVal expression As String) As MathFunction(Of T1, T2, T3, TResult)
        Return New MathFunction(Of T1, T2, T3, TResult)(MathFunction(Of T1, T2, T3, Object, TResult).Create(expression))
    End Function
