...
Public Class SineDataSource
    ...
    Public Overrides ReadOnly Property Description As String
        Get
            Return "Returns the absolute value of sine of the iteration count"
        End Get
    End Property
    ...
    Public Overrides ReadOnly Property Source As String
        Get
            Return My.Resources.SineDataSourceSource
        End Get
    End Property
End Class
